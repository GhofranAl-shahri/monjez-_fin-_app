#  Monjez Fin 
AI-Powered Financial Management & Invoice Automation System.
...
- **Notifications:** Awesome Notifications & Flutter Local Notifications
- **Reporting:** PDF Generation & Professional Printing Support
...
2. **Install Dependencies:**
   ...
   flutter pub get
   ```
3. **Firebase Configuration:** Create a Firebase project and add the `google-services.json` file to the `android/app` directory.
...
**Developed with ❤️ by [Ghofran Al-shahri, Rehab Sabr, Sondos Alkenai, Areej AL-Jawfi]**
